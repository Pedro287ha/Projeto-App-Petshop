...
class Carrinho extends StatefulWidget {
  ...
  @override
  State<Carrinho> createState() => _CartScreenState();
}

class _CartScreenState extends State<Carrinho> {
  @override
          ...
          children: [
            Row(
              children: [
                ...
                const Spacer(),
                const Text("Adicionar Cupom desconto"),
...
List<Product> demoProducts = [
  Product(
    id: 1,
    images: ["https://www.pedigree.com.br/cdn-cgi/image/format=auto,q=90/sites/g/files/fnmzdf2401/files/2022-10/7896029069141-product-image-1.png"],
    colors: [
  ...
  Product(
    id: 2,
    images: [
      "https://www.dogchoni.com.br/assets/uploads/produtos/dogchoni-premium-adultos-vegetais-2.png",
    ],
    colors: [
      const Color(0xFFF6625E),
      const Color(0xFF836DB8),
  ...
  Product(
    id: 3,
    images: [
      "https://www.whiskas.com.br/cdn-cgi/image/format=auto,q=90/sites/g/files/fnmzdf2156/files/2022-10/7896029077245-product-image-1.png",
    ],
    colors: [
      const Color(0xFFF6625E),
      const Color(0xFF836DB8),
